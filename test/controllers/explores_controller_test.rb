...
class ExploresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create explore" do
    assert_difference('Explore.count') do
      post explores_url, params: { explore: { content: @explore.content, title: @explore.title } }
    end
  ...
  test "should update explore" do
    patch explore_url(@explore), params: { explore: { content: @explore.content, title: @explore.title } }
